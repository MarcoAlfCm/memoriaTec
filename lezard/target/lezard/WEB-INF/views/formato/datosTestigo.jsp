...
<div id="tab-datos-testigo">
	...
	<div class="row">
		<div class="row center">
			...
			<a href="continuarQueja?idCaso=${idCaso}" title="Terminar queja" class="btn  waves-light right btnAceptar red " id="btncerrarModalTestigo"> ¡Terminar!
			</a>
...
<%@ include file="/WEB-INF/views/modals/modalDatosTestigo.jsp"%>


<script charset="utf-8" type="text/javascript"
	src="<c:url value="/resources/js/datosTestigo.js" />"></script>
