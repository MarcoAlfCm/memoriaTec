...
<html>
	<head>
		...
		<!-- TITLE -->
		<title>${contextTitle} - Inicia sesión</title>
	</head>
				...
				<div class="row">
					<div class="col s12">
						<div class="valign-wrapper">
							<div class="col s7">
								<div class="row">
									<h5 class="center">BIENVENIDO AL PROGRAMA LEZARD,  SISTEMA PARA EL REGISTRO DE CALIFICACIONES DE MATEMÁTICAS</h5>
								</div>
<!-- 								<div class="row"> -->
...
<!-- 								</div> -->
								<div class="row">
									<div class="card-panel hoverable">
										<span>BIENVENIDO AL PROGRAMA LEZARD. Tiene el propósito de 
											contribuir a la formación de los estudiantes de la Universidad , mediante el conocimiento de las calificaciones y 
											áreas donde fallo el estudiante</span>
									</div>
								</div>
							</div>
								...
								<div class="card">
									<div class=" hoverable card-content center">
										<ul class="tabs" id="tabs-swipe-account">
											<li class="tab col s10 offset-s1"><a class="active" href="#swipe-login">Inicia Sesión</a></li>
											...
											<form action="/lezard/api/authenticate" id="formLogin" method="post" novalidate="novalidate">
												...
												<div class="row">
													<div class="col s8 offset-s2">
														<label><input type="checkbox" id="changeTipoUsuario"><span>Personal Docente</span></label>
														<br><br>
...
<!-- 							<span class="col s10 offset-s1">NOTA: Para el mejor funcionamiento del sistema FOPER, te recomendamos abrir esta página desde el navegador Google Chrome. También te recordamos que el sistema no cuenta con soporte para dispositivos móviles.</span> -->
<!-- 							<br><br> -->
<!-- 						</div> -->
<!-- 					</div> -->
				</div>			
			...
			<div class="container hide-on-large-only" id="spaceMobile">
				<div class="row">
					<div class="col s12">
						<div class="row">
							<h5 class="center">BIENVENIDO AL PROGRAMA DE SEGUIMIENTO DEL FONDO DE PROYECTOS ESPECIALES DE RECTORÍA FOPER</h5>
						</div>
<!-- 						<div class="row"> -->
<!-- 							<img class="center col s6 offset-s3" src="/foper_qa/resources/img/somos_uaq_srec.png"> -->
<!-- 						</div> -->
						<div class="row">
							<div class="card-panel hoverable">
								<span>PROGRAMA DE SEGUIMIENTO DEL FONDO DE PROYECTOS ESPECIALES DE RECTORÍA (FOPER) Tiene el propósito de 
									contribuir a la formación de los estudiantes de la Universidad Autónoma de Querétaro, mediante el desarrollo 
									de proyectos en las diferentes áreas del conocimiento; que impacten en la calidad de vida de la comunidad 
					...
					<div class="col s12">
						<div class="card">
							<div class="card-content center">
								<ul class="tabs" id="tabs-swipe-account">
									<li class="tab col s10 offset-s1"><a class="active" href="#swipe-login-mobile">Inicia Sesión</a></li>
				...
				<div class="row">
					<div class="col s12">
						<div class="card-panel hoverable red white-text col s10 offset-s1">
							<span>NOTA: Para el mejor funcionamiento del sistema FOPER, te recomendamos abrir esta página desde el navegador Google Chrome. También te recordamos que el sistema no cuenta con soporte para dispositivos móviles.</span>
						</div>
					</div>
				</div>
			</div>
		...
		<c:if test="${param.logout != null}">
			<c:set scope="request" var="userMessage" value="Has cerrado sesión exitosamente."></c:set>
		</c:if>
