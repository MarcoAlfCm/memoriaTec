			...
			<div class="row">
				<div class="card col s12 m10 offset-m1 hoverable">
					<div class="card-content">
						...
						<%@ include file="/WEB-INF/views/formato/verDatosIdentificacion.jsp"%> 


						<%@ include file="/WEB-INF/views/formato/verDatosAgresion.jsp"%>

						<%@ include file="/WEB-INF/views/formato/verDatosAgresor.jsp"%>


						<%@ include file="/WEB-INF/views/formato/verDatosTestigo.jsp"%>
...
<%-- 		<script charset="utf-8" type="text/javascript" src="<c:url value="/resources/js/verDatosIdentificacion.js" />"></script> --%>
