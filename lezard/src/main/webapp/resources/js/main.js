var $delay = 5000,
	...
	flagBtnFooter = undefined, 
	$pageFooterBody = undefined;
...
//========== BTN FOOTER ==========
$document.on('click', '#btnFooterInformation', function() {
	if ($pageFooterBody == undefined)
		$pageFooterBody = $(".page-footer-body");

	if (flagBtnFooter != undefined) {
		// OCULTAR
		$pageFooterBody.css({
			display : "none",
			transition : '.3s all'
